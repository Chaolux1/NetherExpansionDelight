...
public class ModBlocks {
    ...
    static {
        ...
        HONEY_GLAZED_HOGHAM_BLOCK = BLOCKS.register("honey_glazed_hogham_block", () -> new RotatedFeastBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), ModItems.HONEY_GLAZED_HOGHAM, true, BlockShapes.HONEY_GLAZED_HAM_SHAPES, BlockShapes.TRAY_SHAPE));
    }
}
